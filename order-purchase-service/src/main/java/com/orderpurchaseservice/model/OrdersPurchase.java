package com.orderpurchaseservice.model;
...
@Entity
@Table(name = "ordenspurchase")
public class OrdersPurchase {
	@Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer idordenpurchase;
	...
	public Integer getIdordenpurchase() {
		return idordenpurchase;
	}

	public void setIdordenpurchase(Integer idordenpurchase) {
		this.idordenpurchase = idordenpurchase;
	}
